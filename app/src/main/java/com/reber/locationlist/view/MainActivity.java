...
import com.reber.locationlist.adaper.PlaceAdapter;
import com.reber.locationlist.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(view);
        db = Room.databaseBuilder(this, PlaceDatabase.class, "Places").build();
